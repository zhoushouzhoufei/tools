...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="data/potsdam/test/imgs")
    parser.add_argument("--mask-dir", default="data/potsdam/test/masks")
    parser.add_argument("--output-img-dir", default="data/potsdam/test/images_1024")
    parser.add_argument("--output-mask-dir", default="data/potsdam/test/masks_1024")
